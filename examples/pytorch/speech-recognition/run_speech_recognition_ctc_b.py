...
class DataTrainingArguments:
    ...
    train_file: str = field(default=None, metadata={"help": "The train csv or json file"})
    validation_file: str = field(default=None, metadata={"help": "The validation csv or json file"})
...
def main():
    ...
    model_type = next(model.named_parameters())[0].split(".")[0]
    no_decay = ["bias", "LayerNorm.weight"]
    optimizer_grouped_parameters = [
        {
            "params": [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and p.requires_grad and model_type not in n],
            "weight_decay": training_args.weight_decay,
            "lr": training_args.learning_rate,
        },
        {
            "params": [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and p.requires_grad and model_type not in n],
            "weight_decay": 0.0,
            "lr": training_args.learning_rate,
        },
    ]
    ...
    optimizer_grouped_parameters += [
        {
            "params": [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and p.requires_grad and model_type in n],
            "weight_decay": training_args.weight_decay,
            "lr": encoder_learning_rate,
        },
        {
            "params": [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and p.requires_grad and model_type in n],
            "weight_decay": 0.0,
            "lr": encoder_learning_rate,
        },
    ]
    ...
    # bh: trainer w/ scheduler
    # from training_utils import ScheduledTrainer
