...
from utils_ner_punct_multiple_choice import DataCollatorForRecasePunct
...
def main():
    ...
    if data_args.train_data_dir is not None or data_args.validation_data_dir is not None or data_args.test_data_dir is not None:
        from dataset_ner_punct_multiple_choice import load_data_files, tokenize_and_align_examples
    ...
    data_collator = DataCollatorForRecasePunct(tokenizer, pad_to_multiple_of=8 if training_args.fp16 else None)
